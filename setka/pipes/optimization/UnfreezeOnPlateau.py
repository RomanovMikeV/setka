...
class UnfreezeOnPlateau(Pipe):
    ...
    """
    def __init__(self, metric, subset='valid', cooldown=5, patience=5, tolerance=1.0e-3, max_mode=False):
        super(UnfreezeOnPlateau, self).__init__()
    ...
    def after_epoch(self):
        if (self.trainer._mode == 'valid' and self.trainer._subset == self.subset):
